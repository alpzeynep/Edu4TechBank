...
namespace Edu4TechBankDL.Migrations
{
    /// <inheritdoc />
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankAccType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAccounts_BankAccType_BankAccTypeId",
                        column: x => x.BankAccTypeId,
                        principalTable: "BankAccType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_BankAccTypeId",
                table: "BankAccounts",
                column: "BankAccTypeId");
